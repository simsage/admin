...
export class SingleSemanticSearchResult extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <Grid container spacing={1} style={styles.gridWidth}>
                ...
                <Grid item xs={11}>
                    <div style={styles.tinmanText} dangerouslySetInnerHTML={{__html: SingleSemanticSearchResult.highlight(item.textList[item.index])}}/>
                </Grid>
                <Grid item xs={1} />
                <Grid item xs={11}>
                    <div style={styles.tinmanText}>{item.url}</div>
                </Grid>
                <Grid item xs={12}>
                    {
...
export default SingleSemanticSearchResult;
