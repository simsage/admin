...
export class Bot extends React.Component {
    ...
    programUploaded() {
        this.props.openDialog("SimSage is now processing these new memories.  Check 'the bot' periodically for updates.", "Uploading Memories", () => this.programUploadedClose());
    }
    ...
    render() {
        ...
        return (
            <div className="mind-page">
               <BotEdit open={this.state.mind_edit}
                        theme={theme}
                                    ...
                                    this.getMemoryList().map((memory) => {
                                        return (
                                            <tr key={memory.id}>
                                                ...
                                                <td>
                                                    <div className="mind-text-column" title={Bot.getDisplayText(memory)}>{Bot.getDisplayText(memory)}</div>
                                                </td>
                                                <td>
