            ...
            <div className={"modal-dialog modal-dialog-centered modal-lg"} role="document">
                <div className="modal-content shadow p-3 mb-5 bg-white rounded">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="staticBackdropLabel">Are you sure you want to refresh the Security ID?</h5>
                    ...
                    <div className="modal-body">
                        <div className="control-row">
                                <span
                                    className="label-wide">This ID can not be recovered and can affect the knowledgeBase if update incorrectly</span>
                        </div>
                    </div>
