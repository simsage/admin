...
export default function OpenSourceSoftwareLicenses() {

    return (
        // <div className="license-container">
        <div className="h-100 p-5 overflow-auto container-fluid">
            <div className="row">

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">kotlin-android-extensions</div>
                    <div className="copyright">Copyright © 2016-2020 JetBrains s.r.o.</div>
                    <div className="license">Apache 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">OpenJDK 11 and 17</div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">jbig2-imageio</div>
                    <div className="copyright">Copyright © 2020 The Apache Software Foundation</div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">cassandra-driver-core</div>
                    <div className="copyright">Copyright © DataStax, Inc.</div>
                    <div className="license">Apache 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">java-driver-core</div>
                    <div className="copyright">Copyright © DataStax, Inc.</div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">guava</div>
                    <div className="copyright">Copyright © 2018, Google Inc.</div>
                    <div className="license">Apache 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">unirest</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">jackson-module-kotlin</div>
                    <div className="license">Apache 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">jackson-module-scala_2.12</div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">slf4j-simple</div>
                    <div className="license">MIT License</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">sysout-over-slf4j</div>
                    <div className="license">MIT License</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">exposed-core</div>
                    <div className="copyright">Copyright © 2016-2020 JetBrains s.r.o.</div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">azure-core</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">azure-core-http-netty</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">netty-all</div>
                    <div className="license">Apache 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">jakarta.annotation-api</div>
                    <div className="license">Eclipse 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">jakarta.websocket-api</div>
                    <div className="license">Eclipse 2.0 license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">azure-identity</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">msal4j-persistence-extension</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">microsoft-graph</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">microsoft-graph-core</div>
                    <div className="copyright">Copyright © 2020 Microsoft Corporation</div>
                    <div className="license">MIT license</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">tess4j</div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">MariaDB Java Client</div>
                    <div className="copyright">Copyright © 2024 MariaDB</div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    ...
                    <div className="copyright">Copyright © 2016, The National
                        Archives &lt;pronom@nationalarchives.gov.uk&gt;</div>
                    <div className="license">BSD License for DROID (Digital Record Object Identification)</div>
                </div>

                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    <div className="title">dropbox-core-sdk</div>
                    <div className="license">MIT license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    ...
                    <div className="copyright">Copyright © 2004, Mikael Grev, MiG InfoCom AB. (base64@miginfocom.com)
                    </div>
                    <div className="license">Apache 2.0 license</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    ...
                    <div className="copyright">Copyright © 2015 Auth0,
                        Inc. &lt;support@auth0.com&gt; (http://auth0.com)
                    </div>
                    <div className="license">MIT License</div>
                </div>
                ...
                <div className="license-section col-sm-12 col-md-6 col-xl-4">
                    ...
                    <div className="copyright">Copyright © 2005 Sun Microsystems , Copyright © 2010-2014 University of
                        Manchester, Copyright © 2015-2018 jai-imageio contributors
                    </div>
