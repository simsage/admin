...
import {calculateDocumentStats, closeUpdateStatsForm, getDocumentStats} from "../document_management/documentSlice";
...
export default function RefreshStatsAsk() {
    ...
    const handleClose = () => dispatch(closeUpdateStatsForm())
                        ...
                        <div className="modal-body text-center">
                            ...
                            <div className="control-rowr">
                                <button onClick={handleClose}
                                        type="button" className="btn btn-white px-4" data-bs-dismiss="modal">
                                    Cancel
                                </button>
                                <button onClick={handleRefresh} type="button" className="btn btn-primary px-4">
                                    Refresh
                                </button>
                            </div>
                        </div>
