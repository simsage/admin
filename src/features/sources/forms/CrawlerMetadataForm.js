...
export default function CrawlerMetadataForm(props) {
    ...
    const [specific_json, setSpecificJson] = useState({})
...
console.log("meta source specificJson metadata_list", props.source.specificJson.metadata_list)
    ...
    useEffect(()=>{
        console.log("specific_json",specific_json)
    },[specific_json])
                ...
                <table className="table">
                        ...
                        get_md_list().map(function(md, index) {
                            return (<tr key={index}>
                                ...
                                <td className="selector-column">
                                    <select className="form-select" onChange={(event) => { set_md_type(md, index, event.target.value) }}
                                ...
                                <td className="td-action">
                                    <button onClick={() => deleteMetadataItem(index)} type="button" className="btn btn-secondary" title="remove this metadata mapping"
                                            data-bs-dismiss="modal">remove this metadata mapping
                                    </button>
                    ...
                    <tr>
                        <td colSpan={5} align={"right"}>
                            ...
                            <button onClick={addNewMetadataMapping} type="button" className="btn btn-secondary" title="add new metadata mapping"
