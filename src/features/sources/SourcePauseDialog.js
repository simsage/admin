...
import {closeForm, pauseSource} from "./sourceSlice";

export function SourcePauseDialog() {
    ...
    const paused = selected_source && !selected_source.scheduleEnable;
    ...
    const message = `Are you sure you want to ${paused ? "unpause" : "pause"} '${source_name}'? `;
    ...
    const handleOk = () => {
        dispatch(pauseSource({session_id:session_id, data:data}))
        dispatch(closeForm());
    }


    if (!show_pause_crawler_prompt)
        return <div/>
                ...
                <div className="modal-content p-4">
                    <div className="modal-body text-center">
                        ...
                        <div className="control-row">
                            ...
                            <button onClick={handleOk} type="button" className="btn btn-primary px-4">
