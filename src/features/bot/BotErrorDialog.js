...
export function BotErrorDialog() {
    ...
    const show_error_form = useSelector((state) => state.botSlice.show_error_form);
    const error_title = useSelector((state) => state.botSlice.error_title);
    const error_message = useSelector((state) => state.botSlice.error_message);
