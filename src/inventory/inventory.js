...
export class Inventory extends React.Component {
    ...
    changePage(page) {
        this.props.setInventoryPage(page);
        this.props.getInventoryList();
        this.props.getInventoryBusy();
    }

    changePageSize(page_size) {
        this.props.setInventoryPageSize(page_size);
        this.props.getInventoryList();
        this.props.getInventoryBusy();
    }
                ...
                {this.isVisible() &&
                    <div>
                        ...
                        <Pagination
                            ...
                            theme={theme}
                            component="div"
                            count={this.props.inventorize_list.totalCount}
                            rowsPerPage={this.props.inventorize_page_size}
                            page={this.props.inventorize_page}
                            backIconButtonProps={{
...
const mapStateToProps = function (state) {
    return {
        ...
        inventorize_page: state.appReducer.inventorize_page,
        inventorize_page_size: state.appReducer.inventorize_page_size,
