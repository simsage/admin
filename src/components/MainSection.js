...
function MainSection(){
    ...
    const global_error_message = error_text ? error_text :
        (org_error_text ? org_error_text : (source_error_message ? source_error_message : ''));
    const global_error_title = error_title ? error_title :
        (org_error_title ? org_error_title : (source_error_message ? 'source error' : ''));
    const global_Show_error = is_error || show_org_error_form || show_source_error;
