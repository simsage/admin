...
window.ENV = {
    ...
    api_base: 'https://adminux.simsage.ai/api', //'http://localhost:8080/api', //'https://uat-cloud.simsage.ai/api',
    // web sockets platform endpoint for comms
    ws_base: 'https://adminux.simsage.ai/ws-api', //'http://localhost:8080/ws-api', //'https://uat-cloud.simsage.ai/ws-api',
